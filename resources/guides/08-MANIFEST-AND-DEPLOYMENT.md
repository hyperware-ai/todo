...
|-------|------|-------------|---------|
| `process_name` | string | Must match your metadata.json package name | `"todo"` |
| `process_wasm_path` | string | Path to compiled WASM file | `"/todo.wasm"` |
