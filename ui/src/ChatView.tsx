      ...
      <div className="chat-input-bar">
        <div className="input-row">
          ...
          {isLoading ? (
            ...
            <button onClick={() => void handleSend()} disabled={!messageDraft.trim()}>
              Send
            </button>
          )}
        </div>
